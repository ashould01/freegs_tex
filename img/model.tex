...
\begin{scope}[on background layer]
  \node[draw=resInk!35, fill=resInk!4, rounded corners=6pt, inner sep=9pt,
        fit=(src)(branch)(dec)(psir)] (gres) {};
  \node[draw=bndInk!35, fill=bndInk!5, rounded corners=6pt, inner sep=9pt,
        fit=(qry)(val)(attn)(decb)(psib)] (gpin) {};
\end{scope}
\node[anchor=south west, font=\small\bfseries, text=resInk]
  at ([xshift=5pt,yshift=2.5pt]gres.north west) {PI-DeepONet\ \ \small\mdseries(residual part $\mathcal{N}_r$)};
\node[anchor=north west, font=\small\bfseries, text=bndInk]
  at ([xshift=5pt,yshift=-2.5pt]gpin.south west) {PINTO\ \ \small\mdseries(boundary part $\mathcal{N}_b$)};
